...
ap.add_argument("-n", "--Number_of_servers", default=1, required=True, help="Number of Fluent sessions to connect", type=int)
...
runner = Runner(
    agent=agent, environment=example_environment,save_best_agent=True
)

runner.run(
    num_episodes=400, max_episode_timesteps=args["Max_interaction_timesteps"])
