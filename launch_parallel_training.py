...
from env import resume_env, nb_actuations, simulation_duration, dt
...
dump = 20
example_environment = resume_env(port=10000, plot=False, step=100, dump=dump, number_controllers=number_controllers, number_actions=number_actions)
